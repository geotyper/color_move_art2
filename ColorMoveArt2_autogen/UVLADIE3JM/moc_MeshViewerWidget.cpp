...
#include <memory>
#include "../../src/MeshViewerWidget.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_MeshViewerWidget_t, stringdata0) + ofs), len 
...
const QMetaObject MeshViewerWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_MeshViewerWidget.offsetsAndSize,
